function [Ensemble,mu_a,spread] = SEnKF(Ensemble,Model,H,jump,Obs,R,L,alpha)
%% Stochastic Ensemble Kalman Filter
% Performs one step of an SEnKF data assimilation algorithm.
% 
% The inputs are an ensemble at time k-1,
% a function handle 'Model', your observations
% at time k and your model time step dt.
% 
% 
...
y_tilde = Obs + sqrt(R)*randn(nobs,Ne);         % perturbations
